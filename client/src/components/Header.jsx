...
const Header = () => {
  ...
  return (
    ...
    <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-16 text-gray-700'>Your own <span className='text-primary'>blogging</span> <br/>platform.</h1>
      ...
      <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs'>This is your space to think out loud,to share that matteers, and to write without filters. Whether it's one word or a thousand, your story starts right here.</p>
      ...
      <div className='text-center'>
       {input &&<button onClick={onClear}className='border font-light text-xs py-1 m-3 px-3 rounded-sm shadow-custom-sm cursor-pointer'> Clear Search</button>}
      </div>
      </div>
